...
```json
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://tbd.ong/posts/hello-world"
  }
}
```
...
```html
<link rel="canonical" href="https://tbd.ong/posts/hello-world" />
```
...
Automatically generated at: `https://tbd.ong/sitemap-index.xml`
